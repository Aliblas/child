...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeeIsOmittedIfImpossible() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    // Have additional employee C with no openings, this should not be considered.
    // 
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalAttendeeIsConsideredIfPossible() {
    // Have each person have different events + one optional. We should see two options because each person has
    // mandatory attendees have three options, optional employee eliminates one option
    // 
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void justEnoughRoomNotEnoughRoomForOptional() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    // Additional optional person is available for same point, but not enough time, and is not considered.
    //
    // Events  : |--A--|     |----A----|
    // Day     : |---------------------|
    // Options :       |-----|
  ...
  public void onlyOptionalAttendeesConsidered() {
    // Have each optional person have different events, no required persons. We should see three options
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
